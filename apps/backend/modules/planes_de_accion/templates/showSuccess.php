...
<div id="sf_admin_container">
    ...
    <ul class='sf_admin_actions' style="margin-left: 6px !important;">
        <li class='sf_admin_action_list'><?php echo link_to('Volver al Listado', '@contribucion_planes_de_accion', array('class' => 'sf_admin_action_cancel')) ?></li>
    </ul>
