...
<div id="content" style="padding-top: 20px !important;">
    <p class="left_ic" style="margin-bottom: 0px;"><strong>COMENTARIO INICIAL</strong></p>
    <span class="producto_comment"><?php echo html_entity_decode($producto->comentario_inicial) ?></span>
</div>
