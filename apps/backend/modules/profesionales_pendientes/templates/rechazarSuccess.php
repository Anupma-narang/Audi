...
<div class="sf_apply sf_apply_settings provider_form">
    <form action="<?php echo url_for('profesionales_pendientes/contacted?profesional_id='.$profesional->id)?>"	method="post">
  ...
  <ul class='sf_admin_actions'>
      <li class='sf_admin_action_list'><?php echo link_to('Volver al Listado', '@profesionales_pendientes', array('class' => 'sf_admin_action_cancel'))?></li>
