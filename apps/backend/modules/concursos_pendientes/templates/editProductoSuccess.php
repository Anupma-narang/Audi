...
<div id="sf_admin_container">
    ...
    <div id="sf_admin_content">
        <div class="sf_admin_form">
            <form method="post" action="/backend.php/concursos_pendientes/editProducto/id/<?php echo $id ?>" enctype="multipart/form-data">
                ...
                <fieldset id="sf_fieldset_none">
                    ...
                    $fields_producto = array(
                        'producto_nombre', 'valida', 'marca', 'modelo', 'persona_contacto', 'email', 'telefono', 'producto_tipo_uno_id',
                        'producto_tipo_dos_id', 'producto_tipo_tres_id', 'lista', 'dividendo', 'divisor', 'lista_cuestionario_id', 'comentario_inicial', 'texto_lista_negra'
                    );
                    ?>
                ...
                <ul class="sf_admin_actions" style="margin-left: 0px !important">
                    <li class="sf_admin_action_list">
                        <a href="/backend.php/concursos_pendientes">Volver al Listado</a>
                    </li>
...
<script language="javascript">
    $(document).ready(function() {
        ...
        /*  $.post("<?php echo url_for('concursos_pendientes/changeCategoryCombo'); ?>", {concurso_tipo_id: 2}, function(data) {
