<div id="content" style="padding-top: 16px !important;">
    ...
    <p class="left_ic" style="margin-bottom: -1px;"><strong>Apellido 2: </strong>
        <span class="com_company"><?php echo $professional_des->last_name_two; ?></span>
    </p>
    <p class="left_ic" style="margin-bottom: -1px;"><strong>Nombre: </strong>
    ...
    <?php endif; ?>
    <p class="left_ic" style="margin-bottom: -1px;"><strong>Localidad: </strong><span class="com_localidad"><?php echo $professional_des->getCpMunicipioProvinciaCongi(); ?></span></p>
...
<div id="content" style="padding-top: 4px !important;">
    <p class="left_ic" style="margin-bottom: 0px;"><strong>PLAN DE ACCIÓN</strong></p>
    <span class="empresa_comment"><?php echo html_entity_decode($cartas->plan_accion) ?></span>
</div>
