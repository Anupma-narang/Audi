...
<div id="content_breadcroum" style="float:left">
    ...
    >>
    <strong><?php echo 'desaprueba'; ?></strong>
</div>
                ...
                <div class="middle">
                    <div id="content_concursos_nuevo">
                        <div class="border-box ML-5 MR-2">
                            <div class="top-left">
                                <div class="top-right">
                                    <h2 style="text-align:center;"><?php echo __('CARTA DE DESAPROBACIÓN'); ?></h2>
                                </div>
                            </div>
                        ...
                        <?php echo $form->renderFormTag(url_for('profesional/' . $sf_params->get('action') . (!$form->getObject()->isNew() ? '?id=' . $form->getObject()->getId() : '')), array("name" => "frmProfesionalDisaproval", "id" => "frmProfesionalDisaproval", "method" => "POST")); ?>
                        <?php echo input_hidden_tag('letter_id', $sf_params->get('letter_id'), array('readonly' => true)); ?>
                        <input type="hidden" name="idprofesional" value="<?php echo $sf_params->get('id') ?>" />
...
//                                        echo '<td>' . $form['email']->render(array('style' => 'width: 193px;', 'disabled' => "disabled")) . '</td>';
                                        ...
                                        <tr>
                                            <td>
                                                <table cellpadding="0" cellspacing="0" width="100%" border="0" class="tableSpace">
                                                    <tr>
                                                        <th width="35%"><?php echo image_tag('/images/bulb.png', array('border' => "0")) ?><?php echo $form['states_id']->renderLabel() ?></th>
                                        ...
                                        <tr>
                                            <td>
                                                <table cellpadding="0" cellspacing="0" width="100%" border="0" class="tableSpace">
                                                    ...
                                                    <tr>
                                                        <th width="24%"><?php echo image_tag('/images/bulb.png', array('border' => "0")) ?>
                                ...
                                <div class="grayBox">
                                    ...
                                    <div class="border-box ML-5 MR-2">
                                        <div class="top-left">
                                            <div class="top-right">
                                                <h2 style="text-align:center; padding:0px; height:27px; line-height:23px;"><?php echo $form['plan_accion']->renderLabel() ?></h2>
                                            </div>
                                        </div>
                                        <div class="bottom-left">
                                            <div class="bottom-right"></div>
                                    ...
                                    <div>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                            <tr>
                                                <td colspan="2" align="left"><br /><?php echo __('Añadir archivos') ?><br /><br /></td>
                                            </tr>
                                            <?php $current_uploads = $sf_request->getFiles($form->getName()); ?>
                                            <tr>
                                                <td>
                                                    <?php echo $form["archivo_1"]["file"]->renderError() ?>
                                                    <input type="hidden" name="profesional_archivo_1_file_persistid_hidden" id="profesional_archivo_1_file_persistid_hidden" />
                                                    <input type="hidden" name="profesional_archivo_2_file_persistid_hidden" id="profesional_archivo_2_file_persistid_hidden" />
                                                    <input type="hidden" name="profesional_archivo_3_file_persistid_hidden" id="profesional_archivo_3_file_persistid_hidden" />
                                                    <input type="hidden" name="profesional_archivo_4_file_persistid_hidden" id="profesional_archivo_4_file_persistid_hidden" />
                                                    <input type="hidden" name="profesional_archivo_5_file_persistid_hidden" id="profesional_archivo_5_file_persistid_hidden" />
                                                </td>
                                            </tr>
                                            <tr id="Archivo_1">
                                                <td style="padding-bottom:10px;">
                                                    <?php global $archivo; ?>
                                                    <?php $archivo = $profesional_letter_archivo[0]->getFile(); ?>
                                                    <?php echo $form["archivo_1"]["file"]; ?>
                                                    <?php $archivo = ''; ?>
                                                    <span style="position:absolute; float:right; margin-left:130px;">
                                            ...
                                            <tr id="Archivo_2">
                                                <td style="padding-bottom:10px;">
                                                    <?php $archivo = $profesional_letter_archivo[1]->getFile(); ?>
                                            ...
                                            <tr id="Archivo_3">
                                                <td style="padding-bottom:10px;">
                                                    <?php $archivo = $profesional_letter_archivo[2]->getFile(); ?>
                                            ...
                                            <tr id="Archivo_4">
                                                <td style="padding-bottom:10px;">
                                                    <?php $archivo = $profesional_letter_archivo[3]->getFile(); ?>
                                            ...
                                            <tr id="Archivo_5">
                                                <td style="padding-bottom:10px;">
                                                    <?php $archivo = $profesional_letter_archivo[4]->getFile(); ?>
                                            ...
                                            <tfoot>
                                                ...
                                                <tr>
                                                    <td align="center" colspan="2">
                                                        ...
                                                        <?php echo link_to(__('cancela'), "@profesional-cartas-draft" . "#top") ?>
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
    ...
    <?php if ($form['incidencia']->hasError()): ?>
        <style type="text/css">
            span#cke_profesional_incidencia {
                border: 2px solid red;
            }
        </style>
    <?php endif; ?>
    <?php if ($form['plan_accion']->hasError()): ?>
        <style type="text/css">
            span#cke_profesional_plan_accion {
                border: 2px solid red;
            }
        </style>
    <?php endif; ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            //alert($('#filename_uploaded1').length);
...
<?php endif; ?>
            ...
            for (i = 1; i <= 5; i++) {
                ...
                $("#filename_uploaded" + i).css("font-weight", "bold");
            }
        ...
        $("#file1_addmore").click(function() {
            $("#Archivo_2").show();
            $("#profesional_archivo_2_file_newfile").trigger("click");
            if ($("#profesional_archivo_2_file_persistid_hidden").val() != "") {
                $("#profesional_archivo_2_file_persistid").val($("#profesional_archivo_2_file_persistid_hidden").val());
            }
        });
        $("#file1_delete").click(function() {
            $("#profesional_archivo_1_file_persistid_hidden").val($("#profesional_archivo_1_file_persistid").val());
            $('#profesional_archivo_1_file_newfile').attr({value: ''});
            $('#profesional_archivo_1_file_persistid').attr({value: ''});
            $('.file_1').attr({value: ''});
            $('#filename_uploaded1').hide();
            $("#file1_delete").hide();
            $('#file_1').show();
            $("#profesional_archivo_1_file_persistid").val($("#profesional_archivo_1_file_persistid_hidden").val());
        });

        $("#file2_addmore").click(function() {
            $("#Archivo_3").show();
            $("#profesional_archivo_3_file_newfile").trigger("click");
            if ($("#profesional_archivo_3_file_persistid_hidden").val() != "") {
                $("#profesional_archivo_3_file_persistid").val($("#profesional_archivo_3_file_persistid_hidden").val());
            }
        });
        $("#file2_delete").click(function() {
            $("#profesional_archivo_2_file_persistid_hidden").val($("#profesional_archivo_2_file_persistid").val());
            $('#profesional_archivo_2_file_newfile').attr({value: ''});
            $('#profesional_archivo_2_file_persistid').attr({value: ''});
            $('.file_2').attr({value: ''});
        ...
        $("#file3_addmore").click(function() {
            $("#Archivo_4").show();
            $("#profesional_archivo_4_file_newfile").trigger("click");
            if ($("#profesional_archivo_4_file_persistid_hidden").val() != "") {
                $("#profesional_archivo_4_file_persistid").val($("#profesional_archivo_4_file_persistid_hidden").val());
            }
        });
        $("#file3_delete").click(function() {
            $("#profesional_archivo_3_file_persistid_hidden").val($("#profesional_archivo_3_file_persistid").val());
            $('#profesional_archivo_3_file_newfile').attr({value: ''});
            $('#profesional_archivo_3_file_persistid').attr({value: ''});
            $('.file_3').attr({value: ''});
        ...
        $("#file4_addmore").click(function() {
            $("#Archivo_5").show();
            $("#profesional_archivo_5_file_newfile").trigger("click");
            if ($("#profesional_archivo_5_file_persistid_hidden").val() != "") {
                $("#profesional_archivo_5_file_persistid").val($("#profesional_archivo_5_file_persistid_hidden").val());
            }
        });
        $("#file4_delete").click(function() {
            $("#profesional_archivo_4_file_persistid_hidden").val($("#profesional_archivo_4_file_persistid").val());
            $('#profesional_archivo_4_file_newfile').attr({value: ''});
            $('#profesional_archivo_4_file_persistid').attr({value: ''});
            $('.file_4').attr({value: ''});
        ...
        $("#file5_delete").click(function() {
            $("#profesional_archivo_5_file_persistid_hidden").val($("#profesional_archivo_5_file_persistid").val());
            $('#profesional_archivo_5_file_newfile').attr({value: ''});
            $('#profesional_archivo_5_file_persistid').attr({value: ''});
            $('.file_5').attr({value: ''});
        ...
        jQuery("#frmProfesionalDisaproval").submit(function(e) {
        ...
        $('#profesional_borrador').bind('click', function() {
            $('#frmProfesionalDisaproval').submit();
        });
    </script>