            ...
            <div id="content-results1" class="main">
                ...
                <div class="middle">
                    <div id="content_concursos_nuevo">
                        ...
                        <form id="frmProfesionalDisaproval" name="frmProfesionalDisaproval"
                              action="<?php echo url_for('profesionaldisaproval/' . $sf_params->get('idprofesional')) ?>" method="post"
                                    ...
                                    <div class="grayBox">
                                        ...
                                        <div>
                                            <ul id="Error_max_length_plan_accion" class="error_list" style="display:none">
                                                <li>Has superado el espacio permitido para tu desaprobación.</li>
                                            </ul>
                                            <?php echo $form['plan_accion']->renderError() ?>
                                            <?php echo $form['plan_accion'] ?>
                                            <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                                <tr>
                                                    <td colspan="2" align="left"><br /><?php echo __('Añadir archivos') ?></td>
                                                </tr>
                                                ...
                                                <tfoot>
                                                    ...
                                                    <tr>
                                                        <td align="center" colspan="2">
                                                            ...
                                                            <?php echo link_to(__('cancela'), $profesional_url . "#top") ?>
                                                        </td>
                                                    </tr>
                                                </tfoot>
                                            </table>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        if($('#filename_uploaded1').length){
            $("tr#Archivo_1 td").css("padding-top", "18px");
            $("#file1_addmore").show();
            $("#file1_delete").show();
            $('#file_1').hide();
        } else {
