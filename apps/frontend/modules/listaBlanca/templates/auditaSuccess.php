                ...
                <div class="middle_audit">
                    <div  >
                        <div class="main cuestionario">
                            ...
                            <form action="<?php echo url_for('lista_blanca_audita_empresa', array('slug' => $empresa->getSlug())) ?>" method="post">
                                ...
                                <div class='preguntas'>
                                    ...
                                    <?php foreach ($form['Preguntas'] as $pregunta) : ?>
                                        <?php //print_r($pregunta['respuesta']);die; ?>
                                        <?php //echo $pregunta->renderLabel(); ?>
                                        <?php if ($pregunta->getName() == "respuesta13"): ?>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('label[for=lista_cuestionario_user_Preguntas_respuesta13_respuesta]:last').hide();
    })
</script>
